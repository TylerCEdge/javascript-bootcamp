!(function (t) {
    ...
    if (e(8)) {
      var r = e(40),
        ...
        Rt = {
          ...
          reverse: function () {
            for (
              var t, n = kt(this).length, e = Math.floor(n / 2), r = 0;
              r < e;
        ...
        (t.exports = function (t, n, e, a) {
          ...
          _
            ? ((v = e(function (t, e, r, i) {
                ...
                if (w(e)) {
                  if (
                    ...
                    return _t in e ? Pt(v, e) : It.call(v, e);
                  (o = e), (p = Et(r, n));
                  var y = e.byteLength;
                  if (void 0 === i) {
                ...
                for (
                  h(t, '_d', { b: o, o: p, l: u, e: c, v: new Y(o) });
                  l < c;
            ...
            : (o(function () {
              ...
              K(m !== Function.prototype ? M(y).concat(M(m)) : M(y), function (
                t
              ) {
                t in v || h(v, t, y[t]);
              }),
  ...
  function (t, n, e) {
    ...
    function V(t, n, e, r, i, o) {
      var u = p(+e);
      if (u + n > t[A]) throw S(_);
      for (var c = t[j]._b, a = u + t[L], s = r(+i), f = 0; f < n; f++)
        c[a + f] = s[o ? f : n - f - 1];
    }
    if (u.ABV) {
      if (
  ...
  function (t, n, e) {
    ...
    t.exports = function (t, n, e, d, g, y, m) {
      ...
      var _,
        ...
        k = !1,
        M = t.prototype,
        O = M[h] || M['@@iterator'] || (g && M[g]),
        P = (!p && O) || x(g),
        F = g ? (E ? x('entries') : P) : void 0,
        I = ('Array' == n && M.entries) || O;
      if (
        (I &&
          (w = l(I.call(new t()))) !== Object.prototype &&
          w.next &&
          (f(w, S, !0), r || c(w, h) || u(w, h, v)),
        E &&
          O &&
          'values' !== O.name &&
          ((k = !0),
  ...
  function (t, n, e) {
    'use strict';
    Object.defineProperty(n, '__esModule', { value: !0 });
    (n.proxy = 'https://cors-anywhere.herokuapp.com/'),
      (n.key = '462b1cc8d4f2730081462fbc65136320');
  },
  function (t, n, e) {
    'use strict';
    function r(t) {
  ...
  function (t, n, e) {
    ...
    t.exports = function (t) {
      return function (n) {
        for (var e, u = i(n), c = r(u), a = c.length, s = 0, f = []; a > s; )
  ...
  function (t, n, e) {
    e(8) &&
      'g' != /./g.flags &&
      e(7).f(RegExp.prototype, 'flags', { configurable: !0, get: e(58) });
  },
  function (t, n) {
    t.exports = function (t, n) {
  ...
  function (t, n, e) {
    t.exports =
      ...
      !e(3)(function () {
        return (
          7 !=
          Object.defineProperty(e(92)('div'), 'a', {
            get: function () {
              return 7;
            },
          }).a
  ...
  function (t, n, e) {
    'use strict';
    Object.defineProperty(n, '__esModule', { value: !0 }),
      (n.deleteLike = n.renderLike = n.toggleLikeMenu = n.toggleLikeBtn = void 0);
    var r = e(47),
      i = e(93);
    (n.toggleLikeBtn = function (t) {
      var n = t ? 'icon-heart' : 'icon-heart-outlined';
      document
        .querySelector('.recipe__love use')
        .setAttribute('href', 'img/icons.svg#' + n);
    }),
      (n.toggleLikeMenu = function (t) {
        r.elements.likesMenu.style.visibility = t > 0 ? 'visible' : 'hidden';
      }),
      (n.renderLike = function (t) {
        var n =
  ...
  function (t, n, e) {
    ...
    (n.renderItem = function (t) {
      ...
      r.elements.shopping.insertAdjacentHTML('beforeend', n);
    }),
      (n.deleteItem = function (t) {
        var n = document.querySelector('[data-itemid="' + t + '"]');
        n && n.parentElement.removeChild(n);
      });
  },
  function (t, n) {
  ...
  function (t, n, e) {
    'use strict';
    Object.defineProperty(n, '__esModule', { value: !0 }),
      (n.updateServingsIngredients = n.renderRecipe = n.clearRecipe = void 0);
    var r = (function () {
        return function (t, n) {
      ...
      u =
        ...
        function (t) {
          if (t) {
            ...
            if (!i[1]) return n;
            if (0 === u) {
              var c = new o.Fraction(n);
              return c.numerator + '/' + c.denominator;
            }
            var a = new o.Fraction(n - u);
            return u + ' ' + a.numerator + '/' + a.denominator;
          }
          return '?';
        });
    (n.renderRecipe = function (t, n) {
      ...
      (n.updateServingsIngredients = function (t) {
  ...
  function (t, n, e) {
    (function (t, n) {
      var e = t && t.pid ? t.pid.toString(36) : '',
        r = null,
        i = r ? parseInt(r.replace(/\:|\D+/gi, '')).toString(36) : '';
      function o() {
        var t = Date.now(),
          n = o.last || t;
        return (o.last = t > n ? t : n + 1);
      }
      (n.exports = function (t) {
        return (t || '') + i + e + o().toString(36);
      }),
        (n.exports.process = function (t) {
          return (t || '') + e + o().toString(36);
        }),
        (n.exports.time = function (t) {
          return (t || '') + o().toString(36);
        });
    }.call(this, e(99), e(142)(t)));
  },
  function (t, n, e) {
    'use strict';
    Object.defineProperty(n, '__esModule', { value: !0 });
                        ...
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (
                              ...
                              (0, _axios2.default)(
                                _config.proxy +
                                  'http://food2fork.com/api/get?key=' +
                                  _config.key +
                                  '&rId=' +
                                  this.id
                              )
                          ...
                          switch ((t.prev = t.next)) {
                            case 0:
                              return (
                                ...
                                (0, u.default)(
                                  c.proxy +
                                    'http://food2fork.com/api/search?key=' +
                                    c.key +
                                    '&q=' +
                                    this.query
                                )
  ...
  function (t, n, e) {
                  ...
                  switch ((t.prev = t.next)) {
                    case 0:
                      ...
                      return (
                        ...
                        c.clearInput(),
                        c.clearResults(),
                        (0, l.renderLoader)(l.elements.searchRes),
                        (t.prev = 6),
                        (t.next = 9),
                        g.search.getResults()
                      );
                    case 9:
                      (0, l.clearLoader)(),
                        c.renderResults(g.search.result),
                        (t.next = 17);
                      break;
                    case 13:
                      (t.prev = 13),
    ...
    l.elements.searchForm.addEventListener('submit', function (t) {
      t.preventDefault(), y();
    }),
      l.elements.searchResPages.addEventListener('click', function (t) {
        var n = t.target.closest('.btn-inline');
        if (n) {
          var e = parseInt(n.dataset.goto, 10);
          c.clearResults(), c.renderResults(g.search.result, e);
        }
      });
    var m,
      _ =
                ...
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      ...
                      return (
                        a.clearRecipe(),
                        (0, l.renderLoader)(l.elements.recipe),
                        g.search && c.highlightSelected(n),
                    ...
                    case 9:
                      g.recipe.parseIngredients(),
                        ...
                        (0, l.clearLoader)(),
                        a.renderRecipe(g.recipe, g.likes.isLiked(n)),
                        (t.next = 20);
                      break;
                    case 16:
                      (t.prev = 16),
      ...
      l.elements.recipe.addEventListener('click', function (t) {
        t.target.matches('.btn-decrease, .btn-decrease *')
          ...
          : t.target.matches('.recipe__love, .recipe__love *') &&
            (function () {
              g.likes || (g.likes = new u.default());
              var t = g.recipe.id;
              if (g.likes.isLiked(t))
                g.likes.deleteLike(t), f.toggleLikeBtn(!1), f.deleteLike(t);
              else {
                ...
                f.toggleLikeBtn(!0), f.renderLike(n);
              }
              f.toggleLikeMenu(g.likes.getNumLikes());
            })();
      });
  ...
  function (t, n, e) {
    e(167), (t.exports = e(27).RegExp.escape);
  },
  function (t, n, e) {
    (function (n) {
      !(function (n) {
  ...
  function (t, n, e) {
    var r = e(0);
    r(r.P + r.R, 'Set', { toJSON: e(104)('Set') });
  },
  function (t, n, e) {
    var r = e(0);
    r(r.P + r.R, 'Map', { toJSON: e(104)('Map') });
  },
  function (t, n, e) {
    'use strict';
    var r = e(0),
      ...
      set: function t(n, e, c) {
        ...
        return u(v, 'value')
          ? !(
              !1 === v.writable ||
              !f(p) ||
              (((l = i.f(p, e) || a(0)).value = c), r.f(p, e, l), 0)
            )
  ...
  function (t, n, e) {
    var r = e(0);
    r(r.G + r.W + r.F * !e(54).ABV, { DataView: e(67).DataView });
  },
  function (t, n, e) {
    'use strict';
    var r = e(0),
        ...
        r = function (t, n) {
          ...
          for (
            ...
            !(
              ...
              a.length > 1 && a.index < e.length && u.apply(h, a.slice(1)),
              (f = a[0].length),
              (v = s),
              h.length >= d)
            );
  ...
  function (t, n, e) {
    var r = e(0);
    r(r.P, 'Array', { copyWithin: e(119) }), e(30)('copyWithin');
  },
  function (t, n, e) {
    'use strict';
    var r = e(0),
  ...
  function (t, n, e) {
    ...
    var r = e(0),
      i = e(18),
      o = [].join;
    r(r.P + r.F * (e(50) != Object || !e(19)(o)), 'Array', {
      join: function (t) {
  ...
  function (t, n, e) {
    var r = e(0);
    r(r.S, 'Object', { setPrototypeOf: e(87).set });
  },
  function (t, n) {
    t.exports =
      Object.is ||
  ...
  function (t, n, e) {
    var r = e(0);
    r(r.S, 'Object', { is: e(348) });
  },
  function (t, n, e) {
    var r = e(0);
    r(r.S + r.F, 'Object', { assign: e(130) });
  },
  function (t, n, e) {
    var r = e(4);
  ...
  function (t, n, e) {
    var r = e(0);
    r(r.S + r.F * !e(8), 'Object', { defineProperties: e(132) });
  },
  function (t, n, e) {
    var r = e(0);
  ...
  function (t, n, e) {
    ...
    var r = e(2),
      ...
      K = function (t) {
        ...
        return (
          !(this === U && i(D, t) && !i(B, t)) &&
          (!(n || !i(this, t) || !i(D, t) || (i(this, R) && this[R][t])) || n)
        );
      },
      X = function (t, n) {
        if (((t = b(t)), (n = w(n, !0)), t !== U || !i(D, n) || i(B, n))) {
          var e = P(t, n);
          return (
            !e || !i(D, n) || (i(t, R) && t[R][n]) || (e.enumerable = !0), e
          );
        }
      },
      $ = function (t) {
        for (var n, e = I(b(t)), r = [], o = 0; e.length > o; )
          i(D, (n = e[o++])) || n == R || n == a || r.push(n);
        return r;
      },
      Z = function (t) {
        for (
          var n, e = t === U, r = I(e ? B : b(t)), o = [], u = 0;
          r.length > u;
    ...
    q ||
      (c(
        (j = function () {
          ...
          return o && G && V(U, t, { configurable: !0, set: n }), z(t);
        }).prototype,
        'toString',
        function () {
          return this._k;
      ...
      (e(49).f = K),
      (e(62).f = Z),
      o && !e(40) && c(U, 'propertyIsEnumerable', K, !0),
      (v.f = function (t) {
        return z(p(t));
      })),
    ...
    u(u.S + u.F * !q, 'Symbol', {
      ...
      j.prototype[T] || e(13)(j.prototype, T, j.prototype.valueOf),
      l(j, 'Symbol'),
      l(Math, 'Math', !0),
      l(r.JSON, 'JSON', !0);
  },
  ...
  function (t, n, e) {
    'use strict';
    (function (t) {
      if ((e(366), e(169), e(168), t._babelPolyfill))
